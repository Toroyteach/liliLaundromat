                        ...
                        >
                            ...
                            >
                                <div className="bg-blue-50 border border-blue-200 rounded-lg p-2.5 sm:p-4 mb-2 sm:mb-4">
                                    <p className="text-xs sm:text-sm text-blue-700">
                                        ...
                                        strong password. Change your password
                                        regularly.
                                    </p>
                                </div>
                            ...
                            >
                                <Tabs defaultValue="manager" className="w-full">
                                    ...
                                    {(
                                        Object.keys(permissions) as Array<
                            ...
                            >
                                <div>
                                    ...
                                    <p className="text-sm text-muted-foreground mt-1">
                                        Our system calculates charges based on
                                        whether an item is priced per piece or
                                        by weight (per Kg).
                                    </p>
                                </div>
