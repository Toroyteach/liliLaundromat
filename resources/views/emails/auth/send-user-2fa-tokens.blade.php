...
<head>
    ...
    <title>{{__('Your 2FA Login Code')}}</title>
    <style>
...
<body style="margin: 0; padding: 0; font-family: 'Inter', Arial, sans-serif; background-color: #f4f4f4;">
    <div style="max-width: 600px; margin: 0 auto; background-color: white; border: 1px solid #ddd; border-radius: 5px; overflow: hidden;">
        ...
        <div style="padding: 30px; text-align: center; font-size: 16px; color: #333;">
            <h1 style="font-size: 24px; color: #333; margin-bottom: 20px; font-family: 'Algreya Sans', Arial, sans-serif;">{{__('Your 2FA Login Code')}}</h1>
            <p style="margin: 0 0 15px; font-family: 'Inter', Arial, sans-serif;">{{__('')}}Hello {{ $userName }},</p>
            <p style="margin: 0 0 15px; font-family: 'Inter', Arial, sans-serif;">{{__('You`ve requested to log in to your account. Use the following code to complete the two-factor authentication process:')}}</p>
            ...
            <p style="margin: 0 0 15px; font-family: 'Inter', Arial, sans-serif;">{{__('This code will expire in 10 minutes. If you didn`t request this code, please ignore this email or contact support if you have concerns.')}}</p>
        </div>

        <!-- Footer Section -->
        <div style="background-color: #ee4c50; text-align: center; padding: 20px; color: white; font-size: 14px;">
            <p style="margin: 0 0 10px; font-family: 'Inter', Arial, sans-serif;">&copy; {{__('Eazy Online')}} , {{ date('Y') }}</p>
